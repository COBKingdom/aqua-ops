...
function Dashboard() {
    ...
    async function fetchData() {
        ...
        const { data: production } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("production").select("bags_produced").gte("date", start).lte("date", end);
        if (production) {
            setTotalBags(production.reduce((sum, item)=>sum + item.bags_produced, 0));
        }
        const { data: sales } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("sales").select("total_amount, balance, amount_paid").gte("date", start).lte("date", end);
        if (sales) {
        ...
        const { data: expenses } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("expenses").select("amount").gte("date", start).lte("date", end);
        if (expenses) {
...
_s(Production, "eFsMeU6wBlPXEDn5LQMr1wiTE+Q=", false, function() {
    return [
...
_s(Sales, "WDgm2eEIlqqYaFvCoXQkHtV6np4=");
_c = Sales;
var _c;
...
_s(Expenses, "i+ET0cDFQVzw/5ZJFbLwn+7zuDI=");
_c = Expenses;
var _c;
...
function Debts() {
    ...
    async function fetchDebts() {
        ...
        if (!range) return;
        const { start, end } = range;
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("sales").select("*").gte("date", start).lte("date", end);
        const grouped = {};
        data?.forEach((item)=>{
...
function BottomNav({ activeTab, setActiveTab }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "fixed bottom-0 left-0 right-0 bg-white shadow-md border-t shadow-sm flex justify-around py-2",
...
_s(WaterFactoryApp, "xHPw8czwx4p9R+GlBIqC9C+RnkM=");
_c = WaterFactoryApp;
var _c;
...
//# sourceMappingURL=Documents_PROJECTS_AquaOps-clean_AquaOps-clean_06~f1sr._.js.map