...
async function getSubscription() {
    try {
        ...
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("saas_customers").select("*").eq("user_id", user.id).limit(1).maybeSingle();
        return data;
    } catch (error) {
...
async function hasActiveAccess() {
    try {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$subscription$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasAppAccess"])();
    } catch (error) {
...
async function getAccessStatus() {
    try {
        const subscription = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$subscription$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSubscription"])();
        if (!subscription) {
            return "expired";
        }
        if (subscription.isAdmin) {
        ...
        if (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$subscription$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isExpired"])()) {
            return "expired";
        }
...
function AdminPayments() {
    ...
    const savePayment = async ()=>{
        try {
            ...
            const { data: currentSub } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("subscriptions").select("*").eq("user_id", factory.user_id).limit(1).maybeSingle();
            ...
            if (currentSub) {
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("subscriptions").update({
                    plan: form.plan,
                    status: "Active",
                    started_at: now.toISOString(),
                ...
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("subscriptions").insert([
                    {
...
//# sourceMappingURL=Documents_PROJECTS_AquaOps-clean_AquaOps-clean_0mcre-0._.js.map