...
function Dashboard() {
    ...
    async function fetchData() {
        ...
        const { data: production } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("production").select("bags_produced").gte("date", start).lte("date", end);
        if (production) {
            setTotalBags(production.reduce((sum, item)=>sum + item.bags_produced, 0));
        }
        const { data: sales } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("sales").select("total_amount, balance, amount_paid").gte("date", start).lte("date", end);
        if (sales) {
        ...
        const { data: expenses } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("expenses").select("amount").gte("date", start).lte("date", end);
        if (expenses) {
...
function Debts() {
    ...
    async function fetchDebts() {
        ...
        if (!range) return;
        const { start, end } = range;
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("sales").select("*").gte("date", start).lte("date", end);
        const grouped = {};
        data?.forEach((item)=>{
...
//# sourceMappingURL=Documents_PROJECTS_AquaOps-clean_AquaOps-clean_02nqvn1._.js.map