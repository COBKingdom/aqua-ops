...
function OnboardingPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("factories").insert([
            {
                name
            }
        ]).select().single();
...
//# sourceMappingURL=Documents_PROJECTS_AquaOps-clean_AquaOps-clean_0i5q254._.js.map