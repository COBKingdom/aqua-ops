...
function Dashboard() {
    ...
    async function fetchData() {
        ...
        const { data: production } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("production").eq("factory_id", factoryId).select("bags_produced").gte("date", start).lte("date", end);
        if (production) {
            setTotalBags(production.reduce((sum, item)=>sum + item.bags_produced, 0));
        }
        const { data: sales } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("sales").eq("factory_id", factoryId).select("total_amount, balance, amount_paid").gte("date", start).lte("date", end);
        if (sales) {
        ...
        const { data: expenses } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("expenses").eq("factory_id", factoryId).select("amount").gte("date", start).lte("date", end);
        if (expenses) {
...
"[project]/Documents/PROJECTS/AquaOps-clean/AquaOps-clean/components/screens/production.tsx [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/Documents/PROJECTS/AquaOps-clean/AquaOps-clean/components/screens/production.tsx'\n\nExpected ',', got ':'");
...
function Debts() {
    ...
    async function fetchDebts() {
        const factoryId1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$factory$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFactoryId"])();
        const range = getDateRange();
        if (!range) return;
        const { start, end } = range;
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("sales").eq("factory_id", factoryId1).select("*").gte("date", start).lte("date", end);
        const grouped = {};
        data?.forEach((item)=>{
    ...
    async function recordPayment(customerName) {
        ...
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PROJECTS$2f$AquaOps$2d$clean$2f$AquaOps$2d$clean$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("sales").eq("factory_id", factoryId).select("*").eq("customer_name", customerName);
...
//# sourceMappingURL=Documents_PROJECTS_AquaOps-clean_AquaOps-clean_0-10fqc._.js.map