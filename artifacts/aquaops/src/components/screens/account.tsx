  ...
  return (
    <div className="p-4 space-y-5 pb-24">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500">Manage your AquaOps account</p>
      </div>
      ...
      <div className="bg-white rounded-2xl p-5 shadow-sm space-y-5">
        ...
        {isAdmin ? (
          ...
          <div>
            ...
            <p className="font-medium">{customer?.factory_name || "-"}</p>
          </div>
        )}
      </div>
      ...
      {isAdmin ? (
        <div className="bg-white rounded-2xl p-5 shadow-sm">
          <h2 className="font-semibold">Platform Administrator</h2>
          <p className="text-sm text-gray-600 mt-2">
            This account manages the AquaOps platform.
          </p>
          <p className="text-sm text-gray-600 mt-1">
            Subscription information is not applicable.
          </p>
        </div>
      ) : (
        <>
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-semibold">{customer?.plan || "Starter"}</p>
              </div>
              <div>
          ...
          {customer?.status === "Trial" && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-5 shadow-sm">
              <h2 className="font-semibold text-yellow-800">Trial Subscription</h2>
              <p className="text-sm text-yellow-700 mt-2">
                Your AquaOps trial expires in {daysRemaining} days.
              </p>
            </div>
          )}
          ...
          <div className="bg-gradient-to-r from-[#0d1b3e] to-[#2563eb] text-white rounded-2xl p-5 shadow-sm space-y-3">
            ...
            <a
              href={supportUrl("Hello AquaOps Support,\n\nI would like to renew or upgrade my subscription.\n\nPlease send payment details.")}
              target="_blank"
              rel="noopener noreferrer"
            >
              <Button className="w-full bg-white text-[#0d1b3e] hover:bg-gray-100">
