  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-gray-50">
      <div className="max-w-sm w-full bg-white rounded-3xl shadow-sm p-8 text-center space-y-5">
        ...
        <h1 className="text-2xl font-bold text-gray-500">Account Archived</h1>
        <p className="text-gray-500 text-sm leading-relaxed">
          This account has been archived. Please contact support if you believe this is an error.
        </p>
        <a
          href={supportUrl("Hello AquaOps Support,\n\nMy AquaOps account appears to be archived. Please assist.")}
          target="_blank"
